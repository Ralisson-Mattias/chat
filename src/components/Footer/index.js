...
export function Footer({sendAction, value, onChangeText, inputRef}) {
    ...
    <>
      <Animated.View style={[styles.card, cardStyle]}>
        <View style={styles.cardContent}>
          <TouchableOpacity activeOpacity={0.8} style={styles.buttonCard}>
      ...
      <View style={styles.container}>
        ...
        {value.length > 0 && (
          <TouchableOpacity activeOpacity={0.8} onPress={sendAction}>
